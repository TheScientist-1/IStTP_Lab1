...
namespace GalleryWebApplication.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(DbgalleryContext context)
        {
            _context = context;
        }
        ...
        {
            var dbgalleryContext = _context.Orders.Include(o => o.Customer).Include(o => o.Status);
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,StatusId,Info,Date")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,StatusId,Info,Date")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbgalleryContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
